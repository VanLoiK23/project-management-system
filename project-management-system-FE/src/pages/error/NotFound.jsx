...
export default function NotFound() {
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-slate-50 px-6 py-24 text-center">
      <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-[2rem] bg-navy-100 shadow-sm ring-1 ring-navy-200">
        <SearchX className="h-12 w-12 text-navy-600" />
      </div>

      <h1 className="bg-gradient-to-br from-navy-600 to-navy-900 bg-clip-text text-7xl font-extrabold tracking-tight text-transparent sm:text-9xl">
        404
      </h1>
      ...
      <p className="mx-auto mt-4 max-w-md text-base leading-7 text-slate-500">
        Đường dẫn bạn đang cố truy cập không tồn tại, đã bị thay đổi hoặc tạm
